...
func _on_click() -> void:
	...
	await C.player.say("This hammer makes me want to destroy something.")
	R.get_prop("Hammer").hide()
	I.Hammer.add()
...
func _on_right_click() -> void:
	...
	await C.player.face_clicked()
	await C.player.say("My dad has got one of these in his workshop. Apparently, it is his favorite tool.")
